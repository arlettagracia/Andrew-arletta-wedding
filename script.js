...
function openInvitation() {
    ...
    if (cover) {
        cover.classList.add("invitation-open");
    }

    // Langsung pindahkan tampilan ke halaman utama agar tidak ada
    // ruang kosong dari tinggi cover setelah undangan dibuka.
